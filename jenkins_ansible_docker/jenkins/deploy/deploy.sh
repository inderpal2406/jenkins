...
scp -i /tmp/prod-user-key /tmp/.auth prod-user@18.138.248.253:/tmp/
scp -i /tmp/prod-user-key ./jenkins/deploy/publish.sh prod-user@18.138.248.253:/tmp/
echo
...
ssh -i /tmp/prod-user-key prod-user@18.138.248.253 "chmod +x /tmp/publish.sh; /tmp/publish.sh"
